    ...
    <>
      <div className="flex flex-col min-h-screen overflow-hidden">
        ...
        <main className="flex-grow">
          ...
          <div className=" bg-white mx-auto px-4 sm:px-6">
            <div className="max-w-6xl pt-32 pb-12 md:pt-40 md:pb-20 m-auto relative isolate overflow-hidden  lg:overflow-visible lg:px-0">
              ...
              <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:mx-0 lg:max-w-none lg:grid-cols-2 lg:items-start lg:gap-y-10">
                ...
                <div className="-ml-12 -mt-12 p-12 lg:sticky lg:top-4 lg:col-start-2 lg:row-span-2 lg:row-start-1 lg:overflow-hidden">
                  <img
                    ...
                    src="https://img.freepik.com/free-photo/person-front-computer-working-html_23-2150040428.jpg?size=626&ext=jpg&ga=GA1.1.705946748.1706705440&semt=ais"
                    alt=""
                  />
                </div>
